...
~/compute-pcrs $ podman run --rm --security-opt label=disable \
  ...
  --mount=type=image,source=quay.io/trusted-execution-clusters/fedora-coreos:42.20250705.3.0,destination=/var/srv/image,rw=false \
...
```dockerfile
FROM quay.io/trusted-execution-clusters/fedora-coreos@sha256:e71dad00aa0e3d70540e726a0c66407e3004d96e045ab6c253186e327a2419e5
...
```sh
$ podman build -f Containerfile -t quay.io/trusted-execution-clusters/fedora-coreos:42.20250705.3.0-tagged-pcrs
```
